    ...
    <section className="py-20">
      <div className="container mx-auto px-6">
        <div className="mb-[80px] text-center animate-fadeInUp">
          <span className="inline-block px-4 py-2 bg-mutedPurple text-purple rounded-full font-extrabold text-[0.85rem] tracking-[0.1em] uppercase mb-5">
        ...
        <div className="machine-list relative pl-[60px] mt-[80px]">
          <div className="step-block relative mb-[60px] opacity-0 animate-fadeInUp blue-step">
          ...
          <div className="step-block relative mb-[60px] opacity-0 animate-fadeInUp purple-step">
        ...
        <div className="hard-sell-gradient-border mt-[150px] py-[100px] px-10 rounded-[60px] text-center animate-fadeInUp">
          <span className="inline-block px-4 py-2 bg-mutedOrange text-orange rounded-full font-extrabold text-[0.85rem] tracking-[0.1em] uppercase mb-5">
            The Final Decision
          </span>

          <h1 className=" font-extrabold tracking-[-0.05em] leading-none">
            One choice. Two outcomes.
          </h1>

          <p className="text-[1.5rem] text-muted mt-5 mb-5">
            Success in business isn&apos;t about working harder...
          </p>

          <div className="grid md:grid-cols-2 gap-[30px] mt-[60px]">
            <div className="md:p-[50px] rounded-[40px] text-left bg-[#f8fafc] border border-[#e2e8f0]">
              <span className="text-[0.85rem] font-extrabold text-[#94a3b8]">
                PATH A: THE GRIND
              </span>

              <h4 className="text-[1.8rem] font-extrabold mb-6 leading-[1.2]">
                Keep guessing.
              </h4>
              ...
              <p className="mt-6 font-extrabold text-[#64748b]">
                Cost: Your time + Your sanity.
              </p>
            </div>

            <div className="p-[50px] rounded-[40px] text-left bg-mutedPurple border-[3px] border-purple shadow-[0_30px_60px_-15px_rgba(169,117,255,0.2)]">
              ...
              <p className="mt-6 font-extrabold text-purple">
                Result: Unfair market leverage.
              </p>
            </div>
          </div>

          <div className="bg-primary text-white py-[80px] px-10 rounded-[48px] mt-[80px] text-center">
            <span className="inline-block px-4 py-2 bg-white/10 text-white rounded-full font-extrabold text-[0.85rem] uppercase mb-5">
              The Logic
            </span>

            <h2 className="text-[3.5rem] max-[850px]:text-[2.2rem] font-extrabold tracking-[-0.05em] text-white">
              Stop Paying the Tax.
            </h2>

            <p className="text-[1.3rem] opacity-80 max-w-[700px] mx-auto">
