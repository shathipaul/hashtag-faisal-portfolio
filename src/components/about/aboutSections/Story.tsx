const StorySection = () => {
  return (
    <section className="py-10 md:py-20 bg-mutedPurple">
        ...
        <div className="grid md:grid-cols-2 gap-10 text-left">
          <div>
            ...
            <p className="text-muted mb-5">
              ...
              emails a day. The result? A digital graveyard of low-relevance
              noise that burns domain reputations and kills buyer trust.
            </p>
          ...
          <div>
            ...
            <p className="text-muted mb-5">
              ...
              and deliverability, but keeps a human operator in the loop for
              tonal nuance and empathy.
            </p>
